...
static void
uint16_t_to_uint8_t(uint8_t *buf, uint16_t uint16Val, uint32_t *index);
static void
uint32_t_to_uint8_t(uint8_t *buf, uint32_t uint32Val, uint32_t *index);
static void
uint64_t_to_uint8_t(uint8_t *buf, uint64_t uint64Val, uint32_t *index);
